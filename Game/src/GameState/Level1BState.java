...
//		JukeBox.load("/SFX/enemyhit.mp3", "enemyhit");
	...
	private void populateEnemies() {
		...
		vrC.setPosition(750, 100);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(900, 150);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(1320, 250);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(1570, 160);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(1590, 160);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(2600, 370);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(2620, 370);
		enemies.add(vrC);
		vrC = new VirutCon(tileMap, player);
		vrC.setPosition(2640, 370);
		enemies.add(vrC);
