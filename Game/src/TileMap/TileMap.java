...
public class TileMap {
	...
	public TileMap(int tileSize) {
		...
		numRowsToDraw = (int)GamePanel.HEIGHT / tileSize +500;
		numColsToDraw = (int)GamePanel.WIDTH / tileSize + 500;
		tween = 0.07;
	}
	...
	public void loadMap(String s) {
		...
		try {
			...
			xmin = (int)GamePanel.WIDTH - width;
			xmax = 0;
			ymin = (int)GamePanel.HEIGHT - height;
			ymax = 0;
	...
	public void setBounds(int i1, int i2, int i3, int i4) {
		xmin = (int)GamePanel.WIDTH - i1;
		ymin = (int)GamePanel.WIDTH - i2;
		xmax = i3;
		ymax = i4;
	}
