...
public class Level1T extends GameState {
    ...
    public Level1T(GameStateManager gsm) {
...
//        mountains = new Background("/Backgrounds/2.png", 0.2);
    ...
    private void populateEnemies() {
        ...
        vrC.setPosition(2500, 1000);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(2800, 1000);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(4350, 700);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(4830, 1030);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(8000, 800);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(8960, 500);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(8960, 500);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(9140, 500);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(9350, 500);
        enemies.add(vrC);
    }
    public int pointDem;
    public void update() {
