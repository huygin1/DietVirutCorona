...
//			JukeBox.play("menuselect");
            ...
            gsm.setState(GameStateManager.LEVEL1T);
        } else if (currentChoice == 1) {

            at.playMenuSelect();
            gsm.setState(GameStateManager.LEVEL2T);
        } else if (currentChoice == 2) {
           
            at.playMenuSelect();
               gsm.setState(GameStateManager.LEVEL3T);
        } else if (currentChoice == 3) {
            at.playMenuSelect();
   gsm.setState(GameStateManager.LEVEL4T);
        } else if (currentChoice == 4) {

            at.playMenuSelect();
               gsm.setState(GameStateManager.LEVEL5T);
        }
    }
