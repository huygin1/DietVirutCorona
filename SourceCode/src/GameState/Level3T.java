...
public class Level3T extends GameState {
    ...
    public Level3T(GameStateManager gsm) {
        super(gsm);
        init();
    }
...
//        mountains = new Background("/Backgrounds/2.png", 0.2);
    ...
    private void populateEnemies() {
        ...
        g.setPosition(3860, 200);
        enemies.add(g);
       
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(3960, 650);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(4183, 650);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(4400, 650);
        enemies.add(vrC);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(4600, 650);
        enemies.add(vrC);
