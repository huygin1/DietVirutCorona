...
public class Level4T extends GameState {
    ...
    public Level4T(GameStateManager gsm) {
        super(gsm);
        init();
    }
...
TieuDe = ImageIO.read(
        ...
        teleport.setPosition(1671, 5939);
    ...
    private void populateEnemies() {
        ...
        g.setPosition(1917, 840);
        enemies.add(g);
         g = new VirutBay(tileMap);
        g.setPosition(1013, 3805);
        enemies.add(g);
         g = new VirutBay(tileMap);
        g.setPosition(1397, 4226);
        enemies.add(g);
        vrC = new VirutCon(tileMap, player);
        vrC.setPosition(1764, 4614);
        enemies.add(vrC);
